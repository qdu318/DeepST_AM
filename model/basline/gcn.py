...
class STGCNBlock(nn.Module):
    ...
    def __init__(self, in_channels, spatial_channels, out_channels, num_nodes):
        ...
        self.Theta1 = nn.Parameter(torch.FloatTensor(in_channels, spatial_channels))
    ...
    def forward(self, X, A_hat):
        ...
        # t = self.temporal1(X)
        lfs = torch.einsum("ij,jklm->kilm", [A_hat, X.permute(1, 0, 3, 2)])
...
class STGCN(nn.Module):
    ...
    def __init__(self, num_nodes, out_channels, spatial_channels, features, timesteps_input,
        ...
        self.fully = nn.Linear(spatial_channels*timesteps_input, timesteps_output)
    ...
    def forward(self, A_hat, X):
        ...
        out4 = self.fully(out1.reshape((out1.shape[0], out1.shape[1], -1)))
